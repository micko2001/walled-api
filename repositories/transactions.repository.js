...
const findAllTransactionsByWalletId = async (walletId) => {
  ...
  try {
    ...
    CASE 
        WHEN t.transaction_type = 'top-up' THEN u.name
        WHEN t.transaction_type = 'transfer' AND t.wallet_id = $1 THEN r_u.name
        WHEN t.transaction_type = 'transfer' AND t.recipient_wallet_id = $1 THEN u.name
